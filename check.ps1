...
foreach ($toolchain in @("MSVC", "GNU")) {
    ...
    foreach ($version in $lastFewVersions) {
        if ($publishedVersions.Contains($version)) {
            ...
            $yamlObject | Add-Member -MemberType NoteProperty -Name PublisherUrl -Value "https://github.com/rust-lang/rust"
            $yamlObject | Add-Member -MemberType NoteProperty -Name PublisherSupportUrl -Value "https://github.com/rust-lang/rust/issues"
            $yamlObject | Add-Member -MemberType NoteProperty -Name Author -Value "The Rust Project Developers"
            ...
            $yamlObject | Add-Member -MemberType NoteProperty -Name CopyrightUrl -Value "https://raw.githubusercontent.com/rust-lang/rust/master/COPYRIGHT"
